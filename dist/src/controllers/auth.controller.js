...
let AuthController = class AuthController {
    ...
    async login(req) {
        return utils_1.ResponseUtils.getSuccessResponse(await this.authService.login(req.user), 'login successful');
    }
};
__decorate([
    (0, common_1.Get)(),
...
], AuthController.prototype, "default", null);
__decorate([
    (0, common_1.Post)('register'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [authValidator_1.createUserDto]),
    __metadata("design:returntype", Promise)
